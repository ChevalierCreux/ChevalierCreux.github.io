//cargar el eventno en una ventana
//-> es una fincion alternativa
window.addEventListener("load",()=>{
    ...
    /*Convierto la HTMLCollection a Array para poder interar*/
    const botonlista = Array.from(botones)

    /*Agrego un evento de click a cada boton*/
    //forEach ----> una simple interacion en su lugar
...
/*Llamo a  una fincion cada vez que ocurra un click*/
